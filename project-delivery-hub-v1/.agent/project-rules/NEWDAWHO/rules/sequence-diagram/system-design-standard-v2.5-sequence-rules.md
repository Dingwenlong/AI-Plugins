...
Use this reference only when generating, checking, repairing, or handing off DAWHO/New DAWHO sequence diagrams. Keep `SKILL.md` as the light entry; load this file for system-design-standard details.

## Delivery Contract

- Formal DAWHO delivery is a Visio source diagram. Normal output should be native editable VSDX, not an SVG image imported into Visio.
