...
Use this reference only for DAWHO/New DAWHO delivery-format and structure checking. It does not decide API business correctness, field semantics, backend-source validity, or cross-file API contract reconciliation.
