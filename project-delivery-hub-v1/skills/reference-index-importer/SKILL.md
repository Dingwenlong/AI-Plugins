...
第 02 步 [$api-spec-writer](<pluginRoot>/skills/api-spec-writer/SKILL.md) 缺少功能 handoff 时，应该先回到 `专案需求接口设计梳理` 生成开发输入包，而不是把 01 当作补救步骤。只有当梳理或 02 明确需要“外部参考资料索引”时，才运行 01。
