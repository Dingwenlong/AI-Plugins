...
The current project native VSDX visual standard is `references/standard-examples/E001_native_reference.vsdx`, copied from project `v1.x Reference/E.001_01.vsdx`. When template behavior is ambiguous, match the E.001 reference.
...
- Use `project-red` only when all message arrows and labels should be red.
