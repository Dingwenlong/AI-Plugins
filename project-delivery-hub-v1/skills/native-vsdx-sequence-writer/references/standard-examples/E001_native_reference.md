...
Use this file as the current project native VSDX style baseline when generating formal sequence diagrams. E.001 is the preferred baseline for native Visio structure and layout.
...
- Use `messageStyle.policy = "project-red"` only when the user explicitly wants all message arrows and labels red.
